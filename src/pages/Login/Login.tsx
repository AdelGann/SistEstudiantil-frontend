...
export const Login = () => {
	...
	return (
		<div className="flex flex-col justify-between sm:flex-row bg-slate-100 bg-white w-full h-[100vh]">
			<form
				onSubmit={handleSubmit}
				noValidate
				className="flex flex-col py-10 mx-auto justify-center self-center align-center xl:w-[405px] h-full"
			>
				<h1 className="tracking-[12px] text-2xl stroke-black text-center">INICIAR SESIÓN</h1>
			...
			<div className="px-4 hidden xl:block sm:px-16 gap-5 bg-[url('/login/login.svg')] w-[951px] bg-no-repeat bg-cover bg-blend-multiply w-full min-h-screen min-h-screen-100% shadow-md"></div>
		</div>
	);
};
